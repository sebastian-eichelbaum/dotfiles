...
call s:hi("HighlightedyankRegion",     s:none,                       s:palette.selectionBG,        [])
"call s:hi("HighlightedyankRegion",     snone,                        s:none,                       [s:attrs.inv])

"}}}

"{{{ QuickScope

call s:hi("QuickScopePrimary",         s:palette.warn,               s:none,                       [s:attrs.u,s:attrs.b])
call s:hi("QuickScopeSecondary",       s:palette.error,              s:none,                       [s:attrs.u,s:attrs.b])

"hi link QuickScopePrimary Warning
"hi link QuickScopeSecondary Error
