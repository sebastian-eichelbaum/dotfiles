...
return {
    setup = function()
        ...
        local boldFont = lib.ternary(style.fontBold == nil or style.fontBold == "", style.font .. " bold", style.fontBold)
        ...
        theme.titlebar_close_button_focus = gears.color.recolor_image(iconPath .. "titlebar/button.svg", theme.palette.attention)
        theme.titlebar_close_button_normal = gears.color.recolor_image(iconPath .. "titlebar/button.svg", theme.palette.bg_lighter3)
        theme.titlebar_minimize_button_focus = gears.color.recolor_image(iconPath .. "titlebar/ring.svg", theme.palette.secondary)
        theme.titlebar_minimize_button_normal = gears.color.recolor_image(iconPath .. "titlebar/ring.svg", theme.palette.bg_lighter3)
